...
* *Main topics covered*
    - [What is Operationg System](#01-what-is-operating-system)
    - [Root](#02-what-is-the-root)
    - [Filesystem](#03-introduction-to-filesystem)
    - [File-Ownership](#04-file-ownership)
    ...
    - [Grepe/grep-text-processors-commands](#12-grepegrep---text-processors-commands)
    - [sort/unip](#13-sortunip---text-processors-commands)
